...
struct ButtonView: View {
   ...
   var config: OrbConfiguration {
	  OrbConfiguration(
		 backgroundColors: isUp ? [.green, .blue, .pink] : [.green, .blue, .pink],
		 glowColor: .white,
		 coreGlowIntensity: isUp ? 1.0 : 0.25,
		 showWavyBlobs: isUp ? true : true,
//		 showWavyBlobs: isUp ? true : false,
		 showParticles: isUp,
		 showGlowEffects: isUp ? true : false,
//		 showShadow:  isUp ? true : false,
		 showShadow:  isUp ? true : false,
		 speed: isUp ? 40 : 30
	  )
   }
