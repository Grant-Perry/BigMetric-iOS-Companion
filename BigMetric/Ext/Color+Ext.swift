...
extension Color {
   ...
   static let gpElectricTeal = Color(red: 0.0, green: 0.93, blue: 0.84)
   static let gpCoral = Color(red: 1.0, green: 0.44, blue: 0.38)
   static let gpSand = Color(red: 0.91, green: 0.79, blue: 0.65)
